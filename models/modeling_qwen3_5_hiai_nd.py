# coding=utf-8
"""NPU-adapted Qwen3.5 text model with an opt-in DFlash V1 feature route.
...
class Qwen3_5TextModel(Qwen3_5PreTrainedModel):
    """HIAI text body with direct post-layer DFlash capture."""

    config: Qwen3_5TextConfig
    dflash_feature_contract_id = "qwen3.5-4b-dflash-hiai-feature-source-v1"
    dflash_feature_source = "package_local:modeling_qwen3_5_hiai_nd.py"
...
class Qwen3_5ForCausalLM(Qwen3_5PreTrainedModel, GenerationMixin):
    """Tensor-returning HIAI causal LM with an opt-in feature tuple."""
