...
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# Modified for this distribution: adds opt-in DFlash V1 target-feature capture
# and portable sibling-overlay imports while preserving the default output ABI.
...
@dataclass
class DFlashQwen3_5ModelOutputWithPast(Qwen3_5ModelOutputWithPast):
    """Opt-in Qwen3.5 base output carrying the selected DFlash features."""

    dflash_features: torch.FloatTensor | None = None
...
class Qwen3_5TextModel(Qwen3_5PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        r"""
        output_dflash_features (`bool`, *optional*, defaults to `False`):
            Return the eight selected post-decoder target features used by the
            Qwen3.5-4B DFlash draft. The ordinary output is unchanged when disabled.
        """
        ...
        for i, decoder_layer in enumerate(self.layers[: self.config.num_hidden_layers]):
            ...
            dflash_collector.capture(i, hidden_states)

        dflash_features = dflash_collector.finalize()
        hidden_states = self.norm(hidden_states)

        output_type = DFlashQwen3_5ModelOutputWithPast if output_dflash_features else Qwen3_5ModelOutputWithPast
        output_kwargs = dict(
            last_hidden_state=hidden_states,
            past_key_values=past_key_values,
        )
        if output_dflash_features:
            output_kwargs["dflash_features"] = dflash_features
        return output_type(**output_kwargs)
...
class Qwen3_5Model(Qwen3_5PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        # This feature-enabled sibling must instantiate its own text model.
        # Going through the global AutoModel registry would silently create the
        # ordinary Transformers class and bypass the selective collector.
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        r"""
        output_dflash_features (`bool`, *optional*, defaults to `False`):
            Forward the opt-in DFlash target-feature request only to the text model.
        image_grid_thw (`torch.LongTensor` of shape `(num_images, 3)`, *optional*):
            The temporal, height and width of feature shape of each image in LLM.
        video_grid_thw (`torch.LongTensor` of shape `(num_videos, 3)`, *optional*):
            The temporal, height and width of feature shape of each video in LLM.
...
class Qwen3_5ForCausalLM(Qwen3_5PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        r"""
        output_dflash_features (`bool`, *optional*, defaults to `False`):
            Include the selected target features in the returned model output.
        ...
        output_type = DFlashCausalLMOutputWithPast if output_dflash_features else CausalLMOutputWithPast
        output_kwargs = dict(
            loss=loss,
            logits=logits,
        ...
        if output_dflash_features:
            output_kwargs["dflash_features"] = outputs.dflash_features
        return output_type(**output_kwargs)
...
@dataclass
class DFlashQwen3_5CausalLMOutputWithPast(Qwen3_5CausalLMOutputWithPast):
    """Opt-in multimodal causal-LM output carrying DFlash target features."""
...
class Qwen3_5ForConditionalGeneration(Qwen3_5PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        output_type = (
            DFlashQwen3_5CausalLMOutputWithPast
            if output_dflash_features
            else Qwen3_5CausalLMOutputWithPast
        )
        output_kwargs = dict(
            loss=loss,
            logits=logits,
