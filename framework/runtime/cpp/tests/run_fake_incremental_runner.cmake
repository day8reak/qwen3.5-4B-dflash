...
set(model_ids)
math(EXPR last_model_index "${model_count} - 1")
foreach(model_index RANGE 0 ${last_model_index})
  string(JSON model_id GET "${report}" models ${model_index} model_id)
  list(FIND model_ids "${model_id}" duplicate_model_id)
  if(duplicate_model_id GREATER -1)
    message(FATAL_ERROR "fake incremental report duplicated model_id=${model_id}")
  endif()
  list(APPEND model_ids "${model_id}")
endforeach()
...
if(MEASUREMENT_PROTOCOL STREQUAL "profile")
  ...
  if(trace_enabled OR NOT trace_length EQUAL 0)
    message(FATAL_ERROR "fake evidence run enabled profile tracing: ${report}")
  endif()
endif()
