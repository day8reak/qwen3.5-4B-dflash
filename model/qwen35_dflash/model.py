...
from .config import Qwen35DFlashConfig
from .ops import DFlashOps, TorchDFlashOps
...
class DFlashRotaryEmbedding(nn.Module):
    def __init__(self, config: Qwen35DFlashConfig) -> None:
        super().__init__()
        inv_freq = 1.0 / (
            config.rope_theta
            ** (
...
class DFlashDraftModel(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.rotary = DFlashRotaryEmbedding(config)
    ...
    def from_pretrained(
        ...
        *,
        ...
        from .weights import load_dflash_weights
